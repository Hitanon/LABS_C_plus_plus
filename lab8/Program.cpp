...
/*
Написать программу для работы с массивом структур «Окружность».
Окружность задается координатами ее центра и радиусом. Написать функцию,
которая вычисляет и возвращает ее площадь. Написать функцию, которая
вычисляет и возвращает ее длину. Написать функцию, которая определяет,
пересекаются две окружности или нет. Использовать в качестве параметра этих
функций данную структуру. Написать функции ввода данных окружности и вывода на
дисплей.Программа должна выводить данные окружностей, хранящихся в массиве, а
также площади и их длины на дисплей в виде таблицы.
Программа должна продемонстрировать работу с массивом:
Найти среднюю площадь тех окружностей из массива, которые пересекаются.
Переместить в конец массива окружности, у которых площадь меньше
заданной.
Удалить из массива окружности, длина которых больше заданной.
Отсортировать массив по возрастанию площади окружности (для консольного
приложения).
*/
